...
from mhe.access.routers import ingest, artifacts, cards, query, consolidations
...
app.include_router(consolidations.router, prefix="/consolidations", tags=["consolidations"])
